...
const CvarDefaultValues = {
  ...
  l4d2_elite_si_core_hp_multiplier: '2.5',
  l4d2_elite_si_core_tank_hp_multiplier: '1.2',
  ...
  l4d2_elite_si_hunter_heroic_explode_time: '6.0',
  l4d2_elite_si_hunter_heroic_damage: '800.0',
  l4d2_elite_si_hunter_heroic_radius: '400.0',
  ...
  l4d2_elite_si_smoker_toxic_gas_enable: '1',
  l4d2_elite_si_smoker_toxic_gas_speed_multiplier: '1.2',
  l4d2_elite_si_smoker_toxic_gas_cloud_cooldown: '10.0',
  l4d2_elite_si_smoker_toxic_gas_cloud_duration: '12.0',
  l4d2_elite_si_smoker_toxic_gas_cloud_radius: '230.0',
  l4d2_elite_si_smoker_toxic_gas_damage_per_second: '10.0',
  l4d2_elite_si_smoker_toxic_gas_damage_interval: '0.2',
  ...
  l4d2_elite_si_smoker_ignitor_enable: '1',
  l4d2_elite_si_smoker_ignitor_burn_duration: '8.0',
  l4d2_elite_si_smoker_ignitor_burn_damage_per_second: '4.0',
  l4d2_elite_si_smoker_ignitor_burn_interval: '0.5',
  l4d2_elite_si_smoker_ignitor_death_fire_duration: '10.0',
  l4d2_elite_si_smoker_ignitor_death_fire_radius: '180.0',
  l4d2_elite_si_smoker_ignitor_death_fire_damage_per_second: '12.0',
  l4d2_elite_si_smoker_ignitor_hint_enable: '1',
  l4d2_elite_si_smoker_ignitor_hint_color: '255 140 40',
  l4d2_elite_si_smoker_ignitor_hint_interval: '1.5',
  ...
  l4d2_elite_si_spitter_acid_pool_enable: '1',
  l4d2_elite_si_spitter_acid_pool_speed_multiplier: '1.2',
  l4d2_elite_si_spitter_acid_pool_trail_cooldown: '2.0',
  l4d2_elite_si_spitter_acid_pool_jump_cooldown: '3.5',
  l4d2_elite_si_spitter_acid_pool_melee_cooldown: '2.0',
  l4d2_elite_si_spitter_acid_pool_approach_range: '900.0',
  l4d2_elite_si_spitter_acid_pool_jump_range: '250.0',
  l4d2_elite_si_spitter_acid_pool_trail_min_distance: '110.0',
  l4d2_elite_si_spitter_sneaky_enable: '1',
  l4d2_elite_si_spitter_sneaky_retreat_range: '300.0',
  l4d2_elite_si_spitter_sneaky_retreat_speed_multiplier: '1.15',
  l4d2_elite_si_spitter_sneaky_cloak_alpha: '102',
  l4d2_elite_si_spitter_sneaky_cloak_duration: '5.0',
  l4d2_elite_si_spitter_sneaky_cloak_cooldown: '7.0',
  l4d2_elite_si_spitter_sneaky_shot_interval: '0.45',
  l4d2_elite_si_spitter_sneaky_shot_spread_distance: '140.0',
  l4d2_elite_si_spitter_sneaky_shot_range: '1400.0',
...
const EliteSIRewardConfig = [
  ...
  { cvar: 'l4d2_elite_si_core_tank_hp_multiplier', type: 'number', label: 'Elite Tank HP Multiplier', desc: 'Hệ số buff máu riêng cho Elite Tank, không dùng chung với Elite SI thường.' },
  ...
  { cvar: 'l4d2_elite_si_hunter_heroic_explode_time', type: 'number', label: 'Hunter Heroic Explode Time', desc: 'Thời gian đếm ngược của pipebomb tính từ lúc Hunter thả xuống hoặc chết.' },
  { cvar: 'l4d2_elite_si_hunter_heroic_damage', type: 'number', label: 'Hunter Heroic Damage', desc: 'Sát thương khổng lồ gây ra khi pipebomb phát nổ.' },
  { cvar: 'l4d2_elite_si_hunter_heroic_radius', type: 'number', label: 'Hunter Heroic Radius', desc: 'Bán kính gây sát thương của vụ nổ pipebomb.' },
  ...
  { cvar: 'l4d2_elite_si_smoker_toxic_gas_enable', type: 'toggle', label: 'Smoker Toxic Gas Enable', desc: 'Bật/tắt chủng Toxic Gas cho Smoker elite bot.' },
  { cvar: 'l4d2_elite_si_smoker_toxic_gas_speed_multiplier', type: 'number', label: 'Smoker Toxic Gas Speed Multiplier', desc: 'Hệ số tốc độ di chuyển của Smoker Toxic Gas.' },
  { cvar: 'l4d2_elite_si_smoker_toxic_gas_cloud_cooldown', type: 'number', label: 'Smoker Toxic Gas Cloud Cooldown', desc: 'Cooldown xả khói khi Toxic Gas Smoker bị shove. Khói lúc chết không chịu cooldown này.' },
  ...
  { cvar: 'l4d2_elite_si_smoker_ignitor_enable', type: 'toggle', label: 'Smoker Ignitor Enable', desc: 'Bật/tắt chủng Ignitor cho Smoker elite bot.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_burn_duration', type: 'number', label: 'Smoker Ignitor Burn Duration', desc: 'Thời gian survivor bị đốt sau khi dính tongue grab hoặc melee từ Ignitor Smoker.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_burn_damage_per_second', type: 'number', label: 'Smoker Ignitor Burn Damage Per Second', desc: 'Sát thương mỗi giây của debuff cháy do Ignitor Smoker gây ra.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_burn_interval', type: 'number', label: 'Smoker Ignitor Burn Interval', desc: 'Khoảng thời gian giữa các lần tick damage của debuff cháy và bãi lửa.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_death_fire_duration', type: 'number', label: 'Smoker Ignitor Death Fire Duration', desc: 'Thời gian tồn tại của bãi lửa được tạo dưới chân Ignitor Smoker khi chết.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_death_fire_radius', type: 'number', label: 'Smoker Ignitor Death Fire Radius', desc: 'Bán kính gây sát thương của bãi lửa khi Ignitor Smoker chết.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_death_fire_damage_per_second', type: 'number', label: 'Smoker Ignitor Death Fire Damage Per Second', desc: 'Sát thương mỗi giây của bãi lửa khi Ignitor Smoker chết.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_hint_enable', type: 'toggle', label: 'Smoker Ignitor Hint Enable', desc: 'Hiện instructor hint tiếng Anh cho survivor đang nhận damage cháy từ Ignitor Smoker.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_hint_color', type: 'text', label: 'Smoker Ignitor Hint Color', desc: 'Màu instructor hint của Ignitor Smoker, định dạng: R G B.' },
  { cvar: 'l4d2_elite_si_smoker_ignitor_hint_interval', type: 'number', label: 'Smoker Ignitor Hint Interval', desc: 'Khoảng nghỉ tối thiểu giữa các instructor hint của Ignitor Smoker cho cùng một survivor.' },
  ...
  { cvar: 'l4d2_elite_si_spitter_acid_pool_enable', type: 'toggle', label: 'Spitter Acid Pool Enable', desc: 'Bật/tắt chủng Acid Pool cho Spitter elite bot.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_speed_multiplier', type: 'number', label: 'Spitter Acid Pool Speed Multiplier', desc: 'Hệ số tốc độ di chuyển của Spitter Acid Pool.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_trail_cooldown', type: 'number', label: 'Spitter Acid Pool Trail Cooldown', desc: 'Cooldown giữa các bãi acid tự động tạo khi Acid Pool Spitter di chuyển.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_jump_cooldown', type: 'number', label: 'Spitter Acid Pool Jump Cooldown', desc: 'Cooldown giữa các lần nhảy để tạo bãi acid của Acid Pool Spitter.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_melee_cooldown', type: 'number', label: 'Spitter Acid Pool Melee Cooldown', desc: 'Cooldown giữa các bãi acid tạo ra khi Acid Pool Spitter cào trúng survivor.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_approach_range', type: 'number', label: 'Spitter Acid Pool Approach Range', desc: 'Khoảng cách tối đa để Acid Pool Spitter chủ động áp sát survivor gần nhất.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_jump_range', type: 'number', label: 'Spitter Acid Pool Jump Range', desc: 'Khoảng cách mục tiêu mà Acid Pool Spitter sẽ ưu tiên nhảy vào để rải acid.' },
  { cvar: 'l4d2_elite_si_spitter_acid_pool_trail_min_distance', type: 'number', label: 'Spitter Acid Pool Trail Min Distance', desc: 'Khoảng cách tối thiểu phải di chuyển trước khi tạo thêm một bãi acid trail mới.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_enable', type: 'toggle', label: 'Spitter Sneaky Enable', desc: 'Bật/tắt chủng Sneaky cho Spitter elite bot.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_retreat_range', type: 'number', label: 'Spitter Sneaky Retreat Range', desc: 'Khoảng cách survivor tiến gần để Sneaky Spitter ưu tiên lùi ra xa.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_retreat_speed_multiplier', type: 'number', label: 'Spitter Sneaky Retreat Speed Multiplier', desc: 'Hệ số tốc độ khi Sneaky Spitter lùi khỏi survivor.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_cloak_alpha', type: 'number', label: 'Spitter Sneaky Cloak Alpha', desc: 'Độ alpha khi Sneaky Spitter tàng hình. 102 tương đương mờ khoảng 60%.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_cloak_duration', type: 'number', label: 'Spitter Sneaky Cloak Duration', desc: 'Thời gian Sneaky Spitter giữ trạng thái tàng hình trong mỗi chu kỳ.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_cloak_cooldown', type: 'number', label: 'Spitter Sneaky Cloak Cooldown', desc: 'Khoảng nghỉ trước khi Sneaky Spitter có thể vào chu kỳ tàng hình tiếp theo sau burst acid.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_shot_interval', type: 'number', label: 'Spitter Sneaky Shot Interval', desc: 'Khoảng thời gian giữa 2 phát acid liên tiếp của Sneaky Spitter.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_shot_spread_distance', type: 'number', label: 'Spitter Sneaky Shot Spread Distance', desc: 'Độ lệch vị trí của phát acid thứ 2 để ưu tiên mở rộng bãi acid hoặc phủ sang mục tiêu khác.' },
  { cvar: 'l4d2_elite_si_spitter_sneaky_shot_range', type: 'number', label: 'Spitter Sneaky Shot Range', desc: 'Khoảng cách tối đa để Sneaky Spitter chọn survivor cho burst acid.' },
...
const EliteSICoreGeneralConfig = [
  ...
  'l4d2_elite_si_core_tank_hp_multiplier',
...
const EliteSITypeSections = {
  smoker: [
    ...
    {
      id: 'smoker-toxic-gas',
      title: 'Smoker - Toxic Gas',
      cvars: [
        'l4d2_elite_si_core_smoker_toxic_gas_subtype_chance',
        'l4d2_elite_si_smoker_toxic_gas_enable',
        'l4d2_elite_si_smoker_toxic_gas_speed_multiplier',
        'l4d2_elite_si_smoker_toxic_gas_cloud_cooldown',
    ...
    {
      id: 'smoker-ignitor',
      title: 'Smoker - Ignitor',
      cvars: [
        'l4d2_elite_si_core_smoker_ignitor_subtype_chance',
        'l4d2_elite_si_smoker_ignitor_enable',
        'l4d2_elite_si_smoker_ignitor_burn_duration',
        'l4d2_elite_si_smoker_ignitor_burn_damage_per_second',
        'l4d2_elite_si_smoker_ignitor_burn_interval',
        'l4d2_elite_si_smoker_ignitor_death_fire_duration',
        'l4d2_elite_si_smoker_ignitor_death_fire_radius',
        'l4d2_elite_si_smoker_ignitor_death_fire_damage_per_second',
        'l4d2_elite_si_smoker_ignitor_hint_enable',
        'l4d2_elite_si_smoker_ignitor_hint_color',
        'l4d2_elite_si_smoker_ignitor_hint_interval'
      ]
    }
  ],
  boomer: [
  ...
  hunter: [
    ...
    },
    {
      ...
      cvars: [
        ...
        'l4d2_elite_si_hunter_heroic_explode_time',
        'l4d2_elite_si_hunter_heroic_damage',
        'l4d2_elite_si_hunter_heroic_radius'
      ]
    }
  ],
  spitter: [
    ...
    {
      id: 'spitter-acid-pool',
      title: 'Spitter - Acid Pool',
      cvars: [
        'l4d2_elite_si_core_spitter_acid_pool_subtype_chance',
        'l4d2_elite_si_spitter_acid_pool_enable',
        'l4d2_elite_si_spitter_acid_pool_speed_multiplier',
        'l4d2_elite_si_spitter_acid_pool_trail_cooldown',
        'l4d2_elite_si_spitter_acid_pool_jump_cooldown',
        'l4d2_elite_si_spitter_acid_pool_melee_cooldown',
        'l4d2_elite_si_spitter_acid_pool_approach_range',
        'l4d2_elite_si_spitter_acid_pool_jump_range',
        'l4d2_elite_si_spitter_acid_pool_trail_min_distance'
      ]
    },
    {
      id: 'spitter-sneaky',
      title: 'Spitter - Sneaky',
      cvars: [
        'l4d2_elite_si_core_spitter_sneaky_subtype_chance',
        'l4d2_elite_si_spitter_sneaky_enable',
        'l4d2_elite_si_spitter_sneaky_retreat_range',
        'l4d2_elite_si_spitter_sneaky_retreat_speed_multiplier',
        'l4d2_elite_si_spitter_sneaky_cloak_alpha',
        'l4d2_elite_si_spitter_sneaky_cloak_duration',
        'l4d2_elite_si_spitter_sneaky_cloak_cooldown',
        'l4d2_elite_si_spitter_sneaky_shot_interval',
        'l4d2_elite_si_spitter_sneaky_shot_spread_distance',
        'l4d2_elite_si_spitter_sneaky_shot_range'
      ]
    }
  ],
  jockey: [
