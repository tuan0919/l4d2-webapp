...
const EliteSIRewardConfig = [
  ...
  { cvar: 'l4d2_elite_si_core_smoker_force_subtype', type: 'number', label: 'Force Smoker Subtype (test)', desc: '0=random, 2 ép Strange Movement, 28 ép Pull Weapon Drop, 29 ép Toxic Gas để test.' },
